...
REGION_BOARDS = [
    ...
    {"region": "Current freight and inputs", "note": "US BLS deep-sea freight PPI and IMF coal and iron-ore prices, updated to 2026 (monthly, via FRED)",
     "series": [("DEEPSEA_PPI", "Deep-sea freight PPI", "pts"), ("COAL_AUS", "Australian coal", "usd/t"), ("IRON_ORE", "Iron ore", "usd/t")]},
