...
**Running total: 56 done, 1 partial, 0 not started** (of 57) at the last full recount, plus rows 74 to 77 added afterwards (live refresh, calibrated bands, market-linked cost, the COA spacing fix), all done. Backend tests: 66 passing, 1 skipped. The one partial item is #14: in-app and webhook alerts work, but WhatsApp/SMS delivery needs a messaging-provider account. There is also an ROI calculator (live in `Financial.tsx`) from the original 20-feature plan that isn't separately numbered here.
