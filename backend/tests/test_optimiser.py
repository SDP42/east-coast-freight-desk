"""Optimiser, verdict-evidence and embedding-routing tests."""

import pytest

from app.db.session import SessionLocal
from app.models import Port
from app.services import optimiser, verdict_eval
...
def test_verdict_evidence_reports_both_series(db):
    ...
    assert {t["series"] for t in ev["tests"]} == {"USDA grain ocean rate", "Brent crude"}
