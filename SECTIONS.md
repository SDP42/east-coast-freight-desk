...
- **Still needs the user**: creating the Neon, Render and Vercel accounts and pasting the connection string; deciding what to do about the BDI data licence before a public deployment (see DEPLOYMENT.md).
